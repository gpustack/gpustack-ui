      ...
      ((n.win32 = {
        ...
        relative(i, r) {
          ...
          if (V !== P) {
            ...
            (_ > P &&
              (i.charCodeAt(v + V) === c ? (R = V) : V === 2 && (R = 3)),
              R === -1 && (R = 0));
          }
          let B = '';
          for (V = v + R + 1; V <= o; ++V)
        ...
        (n.posix = {
          ...
          parse(i) {
            ...
            return (
              o > 0 ? (r.dir = i.slice(0, o - 1)) : l && (r.dir = '/'),
              r
            );
          },
          sep: '/',
    ...
    j(z[10], G([0, 1, 14, 22]), function (F, n, A, D) {
      ...
      class c {
        ...
        _ComputeDiff(e, f, m, N, b) {
          ...
          return (
            b && (S = this.PrettifyChanges(S)),
            { quitEarly: h[0], changes: S }
          );
        }
          ...
          for (let T = 1; T <= o / 2 + 1; T++) {
            ...
            for (let W = g; W <= v; W += 2) {
              (W === g || (W < v && E[W - 1] >= E[W + 1])
                ...
                (i = p - (W - P) - V));
              const Y = p;
              for (; p > e && i > m && this.ElementsAreEqual(p, i); )
                (p--, i--);
    ...
    function (F, n, A, D, w, s, d, a, u, c, C, e, f, m, N) {
      ...
      class b extends u.MirrorTextModel {
        ...
        getValueInRange(i) {
          ...
          return (
            v.push(this._lines[g].substring(0, i.endColumn - 1)),
            v.join(r)
          );
        }
        offsetAt(i) {
      ...
      class h {
        ...
        _getModels() {
          let i = [];
          return (
            Object.keys(this._models).forEach((r) => i.push(this._models[r])),
            i
          );
        }
        acceptNewModel(i) {
