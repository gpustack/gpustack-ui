export default {
  ...
  'models.import.empty.description':
    'Dağıtımları tanımlayan bir dosya seçin. İçe aktarmadan önce seçili kümeyle karşılaştırılır ve yazılacak her şey farkta eksiksiz gösterilir.',
  ...
  'models.import.counts':
    '{count} dağıtım · {cluster} kümesine göre denetlendi · {changes} değişiklik',
