export default {
  ...
  'models.form.evaluating': 'Проверка...',
  'models.form.incompatible': 'Несовместимо',
  'models.form.restart.onerror': 'Автоперезапуск при ошибке',
  'models.form.restart.onerror.tips': 'При возникновении ошибки будет автоматически предпринята попытка перезапуска.'
};
