export default {
  ...
  'resources.worker.add.step1': 'Получить токен <span class="note-text">(выполнить на сервере)</span>',
  'resources.worker.add.step2': 'Зарегистрировать воркер',
  'resources.worker.add.step2.tips': 'Примечание: выполнить на добавляемом воркере, <span style="color: #000;font-weight: 600">mytoken</span> токен, полученный на первом шаге.',
