export default {
  ...
  'common.login.captcha.holder': '请输入图中字符',
  'common.login.captcha.tip': '验证码不区分大小写，点击图片可刷新。',
  'common.login.captcha.error': '无法加载验证码，请点击刷新重试。',
  'common.login.captcha.audio.listen': '收听验证码',
  'common.login.captcha.audio.label': '语音验证码',
  'common.login.captcha.audio.error': '无法加载语音验证码，请重试。',
