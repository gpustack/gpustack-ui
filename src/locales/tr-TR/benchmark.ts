export default {
  ...
  'benchmark.form.concurrencyList': 'Eşzamanlılık Seviyeleri',
  'benchmark.form.loadType': 'Yük Türü',
  'benchmark.form.loadType.fixedRate': 'Sabit Hız',
  'benchmark.form.loadType.concurrency': 'Eşzamanlılık',
  'benchmark.form.loadType.sweep': 'Otomatik Tarama',
  ...
  'benchmark.form.rateList': 'İstek Hızları (istek/sn)',
  'benchmark.detail.overview.rate': 'Hız / Eşzamanlılık',
  ...
  'benchmark.form.slo.ttft': 'Ort. TTFT ≤ (ms)',
  'benchmark.form.slo.p95Ttft': 'P95 TTFT ≤ (ms)',
  'benchmark.form.slo.p99Ttft': 'P99 TTFT ≤ (ms)',
  'benchmark.form.slo.tpot': 'Ort. TPOT ≤ (ms)',
  'benchmark.form.slo.p95Tpot': 'P95 TPOT ≤ (ms)',
  'benchmark.form.slo.p99Tpot': 'P99 TPOT ≤ (ms)',
  'benchmark.form.slo.avgLatency': 'Ort. Gecikme ≤ (ms)',
  'benchmark.form.slo.p95Latency': 'P95 Gecikme ≤ (ms)',
  'benchmark.form.slo.p99Latency': 'P99 Gecikme ≤ (ms)',
  ...
  'benchmark.form.concurrencyList.tips':
    'Her eşzamanlılık seviyesi için ayrı bir kıyaslama çalıştırır (örneğin 40, 60, 80). Yukarıdaki tek İstek Hızını kullanmak için boş bırakın.',
  'benchmark.form.concurrencyList.placeholder': 'örn. 40, 60, 80',
  ...
  'benchmark.form.profile.custom.tips':
    'Otomatik ayar arama aralığını veya elle bir aşama listesini kendiniz belirleyin — her alan düzenlenebilir.',
