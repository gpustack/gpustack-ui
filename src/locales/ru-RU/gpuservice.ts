export default {
  ...
  'gpuservice.instance.mode.partitioned': 'По профилю',
  ...
  'gpuservice.instance.partitioned': 'Раздел',
  'gpuservice.instance.partition.profile': 'Профиль раздела',
  'gpuservice.instance.partition.profile.required': 'Выберите профиль раздела',
  'gpuservice.instance.partition.profile.unavailable':
    'Этот профиль больше недоступен в пуле, выберите другой',
  'gpuservice.instance.memory': 'VRAM',
  'gpuservice.instance.ram': 'RAM',
  'gpuservice.instance.os': 'ОС',
  'gpuservice.instance.arch': 'Архитектура',
  'gpuservice.instance.utilization.accelerator': 'Использование ускорителя',
  'gpuservice.instance.utilization.basic': 'Использование ресурсов',
  'gpuservice.instance.utilization.gpu': 'GPU',
  'gpuservice.instance.utilization.vram': 'VRAM',
  'gpuservice.instance.utilization.cpu': 'CPU',
  'gpuservice.instance.utilization.memory': 'Память',
  'gpuservice.instance.utilization.storage': 'Хранилище',
