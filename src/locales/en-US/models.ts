export default {
  ...
  'models.import.empty.description':
    'Pick a file describing one or more deployments. It is checked against the selected cluster first, and the diff shows exactly what would be written before anything is.',
  ...
  'models.import.counts':
    '{count} deployment(s) · checked against {cluster} · {changes} change(s)',
